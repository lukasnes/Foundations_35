...
let bobsTotal = purchases.reduce((accumulator,currentElement) => {
  // console.log(currentElement)
  // console.log(currentElement.owner)
  if(currentElement.owner === "Bob"){
...
let bobsFilter = purchases.filter((priceObj) => priceObj.owner === "Bob").reduce((acc,curr) => acc + curr.price,0)
